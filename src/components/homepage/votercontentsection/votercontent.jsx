...
export default function Votercontent() {
  return (
    ...
    <div className="w-1/2 m-10 text-justify">
        ...
        <p className='my-3'>
           To cast your vote, simply log in to the voting platform using your matric number and password. If you have any issues logging in, please contact the administrator for assistance.
        </p>
    </div>
    </div>

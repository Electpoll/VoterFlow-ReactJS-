  ...
  return (
    <section className='m-10 w-1/2 h-screen'>
        ...
        <div className="mt-40">
            ...
            <h1 className='my-4 font-bold text-3xl'>NAMSSN UI Elections - Empower Your Voice, Shape The Future, Vote Your Choice!</h1>
            <p className='my-2'>Welcome to NAMSSN UI Elections powered by Electpoll. We&apos;re here to empower your voice and make voting your choice easier than ever. Your vote matters. Make it count! Click below to cast your vote and participate in shaping the future of NAMSSN UI.</p>
             <Link to={'/login'}> <button className="bg-amber-500 text-black rounded-lg border-2 border-transparent py-2 px-8 my-5 font-bold hover:bg-black hover:text-amber-500 transition-all">Vote Now</button></Link>
